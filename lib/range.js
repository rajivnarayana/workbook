...
function range(wb, sheetIndex, topLeft, bottomRight) {
    ...
    Object.defineProperty(this.constructor, "name", { get: function () { return "range"; } })
...
range.prototype.cells = function (mode) {
    ...
    a = workbookUtils.resolveCell(this.topLeft);
    b = workbookUtils.resolveCell(this.bottomRight);
...
range.prototype.hit = function (addr) {
    ...
    target = workbookUtils.cellInfo(addr);
    a = workbookUtils.resolveCell(this.topLeft);
    b = workbookUtils.resolveCell(this.bottomRight);
...
range.prototype.set = function (values) {
    ...
    var topLeft = workbookUtils.resolveCell(this.topLeft);
...
range.prototype.toString = function () {
    return workbookUtils.sheetName(this.workbook.sheetNames[this.sheetIndex], this.topLeft.addr()) + ":" + this.bottomRight.addr();
}
